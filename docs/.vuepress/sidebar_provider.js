...
module.exports = {
    ...
    /**
     * Returns an object with properties that represent the sidebar definition for the entire site.
     * Dynamically generates from the SUMMARY.md file stored in the top level of each section of the docs
     * @param {*} rootPath 
     * @returns 
     */
    getMultiSidebar: function (rootPath){

        //find all directories in the root path to generate a sidebar for
        ...
        console.log(result_sidebar)
        return result_sidebar
    },
   
   
    sidebar: function(section) {
      summaryfile_path=path.resolve(__dirname, '..',section,'SUMMARY.md')
      ...
      try {
          ...
          console.error('SUMMARY.md definition file not found for /' + section + '/' + 
            '\n    Falling back to auto sidebar');
          return [ ['/'+section+'/','auto'],]
      }
