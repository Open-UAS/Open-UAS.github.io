# Previous Electrical Configurations

## OpenUAS 3.0
This section lists the electronic hardware on OpenUAS 3.0, as well as their component weights and location in the wiring diagram.
...
- Dimensions: (see below)
- Weight: 22 grams
- https://hobbyking.com/en_us/corona-ds-239hv-digital-slim-wing-servo-metal-gear-4-6kg-0-13sec-22g.html
